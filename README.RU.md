[![EN](https://user-images.githubusercontent.com/9499881/33184537-7be87e86-d096-11e7-89bb-f3286f752bc6.png)](https://github.com/r57zone/PCRemKey/) 
...
[![](https://github.com/user-attachments/assets/8fbc3401-f3e5-430e-8647-4d17856d9b7b)](https://github.com/user-attachments/assets/36ecb71b-eae3-4b95-a00f-c5574b560b3b)
[![](https://github.com/user-attachments/assets/0851fabf-745d-495e-97f1-061f10216f87)](https://github.com/user-attachments/assets/3732208f-7a6e-4dcd-8a0f-1766d91a7207)
...
Если клавиатура Windows отличается от клавиатуры на мобильном устройстве, то нажмите `ALT + LANG` (смена раскладки на ПК).


Второй язык определяется автоматически, при необходимости его можно сменить вручную нажав `CTRL + ALT + =`.


Сменить чувствительность мыши `CTRL + ALT + \`.
...
### Android
Установите `PCRemKey.apk` и введите зарезервированный постоянный IP вашего компьютера. 
